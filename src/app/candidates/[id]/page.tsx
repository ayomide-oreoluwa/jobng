    ...
    <div className="min-h-screen bg-gray-50 pt-20">
      ...
      <div className="bg-gradient-to-r from-gray-900 to-blue-950 py-14">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Link href="/candidates" className="inline-flex items-center gap-2 text-blue-200 hover:text-white text-sm mb-6 transition-colors">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5">
            ...
            <div className="flex-1">
              ...
              <p className="text-blue-300 font-medium mb-1">{candidate.title}</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
              ...
              <div className="flex flex-wrap gap-2">
                {candidate.skills.map((skill) => (
                  <span key={skill} className="bg-blue-50 text-blue-700 text-sm font-medium px-4 py-1.5 rounded-lg border border-blue-100">
                    {skill}
                  </span>
                ))}
              </div>
          ...
          <div className="space-y-5">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm sticky top-28">
              ...
              <Link
                href="/login"
                className="flex items-center justify-center gap-2 w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 rounded-xl text-sm transition-colors mb-3"
              >
                <FiMessageSquare size={14} /> Send Message
              </Link>
              <button className="flex items-center justify-center gap-2 w-full border border-gray-200 hover:border-blue-300 text-gray-600 hover:text-blue-600 font-semibold py-2.5 rounded-xl text-sm transition-colors">
                ...
                <>
                  ...
                  <div className="flex items-center gap-2">
                    {candidate.socialLinks.map(({ platform, url }) => {
                      ...
                      return (
                        <a key={platform} href={url} className="w-8 h-8 flex items-center justify-center bg-gray-100 hover:bg-blue-600 hover:text-white text-gray-600 rounded-lg transition-colors">
                          <Icon size={14} />
                        </a>
                      );
                    })}
